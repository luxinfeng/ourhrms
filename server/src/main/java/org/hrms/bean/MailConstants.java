...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "hrms.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "hrms.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "hrms.mail.routing.key";
}
