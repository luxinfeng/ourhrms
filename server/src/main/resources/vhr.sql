...
DELIMITER ;;
CREATE DEFINER=`root`@`cdb-im0zj1ho.cd.tencentcdb.com` PROCEDURE `addDep`(in depName varchar(32),in parentId int,in enabled boolean,out result int,out result2 int)
begin
  declare did int;
...
DELIMITER ;;
CREATE DEFINER=`root`@`cdb-im0zj1ho.cd.tencentcdb.com` PROCEDURE `deleteDep`(in did int,out result int)
begin
  declare ecount int;
  declare pid int;
  declare pcount int;
